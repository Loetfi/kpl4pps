...
class SerbaUsahaController extends Controller
{
	public function list(Request $request){
		try { 
			...
			$data_agama = Layanan::join('apps_kategori_channel','apps_layanan.id_layanan','=','apps_kategori_channel.id_layanan')->where('apps_layanan.id_layanan',4)->select('nama_kategori','gambar_kategori','id_kategori','apps_kategori_channel.id_layanan')->get();
